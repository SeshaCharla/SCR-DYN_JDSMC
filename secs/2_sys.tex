...
The SCR-ASC subsystem in the diesel engine after-treatment systems involves reacting flow on the top of a catalyst which adsorbs ammonia from urea decomposition. The following lists all the reactions that take place inside the SCR-ASC chamber.
